...
public class CommandSafetyTests
{
    ...
    public void UpdateRepairsMissingLinkWithoutDuplicateOwnership()
    {
        ...
        var manifest = System.Text.Json.JsonSerializer.Deserialize<InstallManifest>(File.ReadAllText(Path.Combine(home, ".codex/codex-toolkit-install.json")), AgentTool.Json)!;
