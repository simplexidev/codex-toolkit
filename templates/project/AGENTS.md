...
- Build/test entry points and required fixtures: [paths and commands].
- Compatibility and release constraints: [supported consumers and gates].
- Generated files or protected areas: [paths and regeneration command].
